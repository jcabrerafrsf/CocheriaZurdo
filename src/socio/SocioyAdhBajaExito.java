 ...
 * @author juani
 */
public class SocioyAdhBajaExito extends javax.swing.JFrame {

    /**
     * Creates new form SocioyAdhBajaExito
     */
    public SocioyAdhBajaExito() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SOCIO Y ADHERENTES DADOS DE BAJA CON EXITO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SocioyAdhBajaExito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SocioyAdhBajaExito().setVisible(true);
            }
        });
    }
