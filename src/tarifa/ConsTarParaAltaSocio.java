 ...
 * @author juani
 */
public class ConsTarParaAltaSocio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel20.setText("N° DE TARIFA A CARGAR:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsTarParaAltaSocio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsTarParaAltaSocio().setVisible(true);
            }
        });
    }
