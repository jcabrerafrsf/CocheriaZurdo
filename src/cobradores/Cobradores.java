...
public class Cobradores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/caja-registradora.png"))); // NOI18N
    ...
    private void jCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCargarActionPerformed
        CargarCobrador CC = new CargarCobrador();
        this.dispose();
    ...
    private void jConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jConsultarActionPerformed
        ConsultarCobradores CCb = new ConsultarCobradores();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cobradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
